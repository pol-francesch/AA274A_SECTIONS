...
\title{AA 274A: Principles of Robot Autonomy I \\ Section 3 (In-person): Introduction to Turtlebot Hardware and Gazebo}
\date{}
...
\input{sec_turtlebot_teleop}

\section{Hardware Shutdown}
...
\input{sec_turtlebot_genbu_addon}
